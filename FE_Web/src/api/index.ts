...
// tạo từ thư viện axios để thực hiện các yêu cầu http
const axiosApiInstance = axios.create()
// import.meta.env.VITE_API_URL: truy cập biến môi trường. Biến này chứa URL của API mà ứng dựng sẽ kết nối sử dụng
//
